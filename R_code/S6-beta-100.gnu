...
set output "log-errors-beta-100.eps"
set size 3/6., 3/6.
set nogrid
# unset xtics 
# unset ytics 
...
set label 1 front at xPos, graph 0 "q=<{/Symbol q}>=0.0098" offset 0.5,6.0 tc lt 4
set style fill transparent solid 0.5 noborder
plot \
f(x,1+n,1+N-n) title "N=100,n=0" w filledcurves x1 lt 1 lc 4 lw 2
